...
*/
//Второй вариант: если у нас два повторяющихся числа.
/*
...
*/
/*
//Задача 4. Создаем задачку, чтобы массив сам определял свою длину. 
...
void FillArray(int[] collec)       
{
    ...
    while(index < length)          
    {
        сollec[index] = new Random().Next(1, 10);   
        //index = index + 1;                        
        index++;       
    }
}
...
PrintArray(array);  
*/          
//Задача 4.2 Попробуем адаптировать решение предыдущей задачи.
